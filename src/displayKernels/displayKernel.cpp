...
const unsigned char reverseByte[] = {
...
const int moveMap[16] = { 0, -1, -2, -3, -4, -5, -6, -7, 8, 7, 6, 5, 4, 3, 2, 1 };

static const unsigned char positionLookup[] =
{
...
void DisplayKernel::strobePosition(unsigned char strobeAddress, int position)
{
	int i;
	vcsNop2n(8);
	while (position < 0)
